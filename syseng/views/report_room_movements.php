...
if(!isset($history)) {   $history[1]["roomId"] = "NotSet"; $history[1]["transition"] = Null; }
...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && (!empty($_POST['submit']))):
  ...
  include('../include/get_history_room_usage.php');
      ...
      <div class="row" id="tall-div">
        <div class="large-10 medium-10 small-10 columns">
          ...
          <div class="row">
            <div class="large-12 medium-12 small-12 columns">
              <fieldset>
                <legend>Rooms ordered by people moving through for the selected period of time</legend>
                    ...
                    <div class="large-4 columns">
                      <div class="row collapse prefix-radius">
                        ...
                        <div class="small-9 columns">
                          <input type="text" name="startdate" id="startdate"  autofocus  required 
                                  placeholder="MM/DD/YYYY" value="<?php if (isset($startdate)) { echo $startdate; } ?>">
                          <?php if (isset($err_startdate)) { echo $err_startdate; } ?>
