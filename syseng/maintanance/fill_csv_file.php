...
while(true) {
	while (true) {
		...
		$occR1 = $rl=='0000000000'?5:$roomArr[$rl];
		$occR2 = $roomArr[$rr];

		if($occR1==$occR2 && $occR1==0) continue;	// both rooms are empty, so find other door. Random error could be emulated
...
function post_data( &$data ){
	...
	$url = 'http://localhost/bs/distapr/php/add_data_array.php';
